...
class NativeViewFactory(private val messenger: BinaryMessenger, private val errorListener: PlayerErrorListener) : PlatformViewFactory(StandardMessageCodec.INSTANCE) {
    companion object {
    ...
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        ...
        nativeView.errorListener = errorListener
